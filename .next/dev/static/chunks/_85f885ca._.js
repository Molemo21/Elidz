...
"[project]/app/test-auth-debug/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TestAuthDebugPage() {
    _s();
    const { user, loading, isAdmin, isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const testGetCurrentUser = async ()=>{
        ...
        try {
            const { AuthService } = await __turbopack_context__.A("[project]/lib/auth.ts [app-client] (ecmascript, async loader)");
...
_s(TestAuthDebugPage, "cGZ6rOakRQU9eCv4qoEHGtF1rts=", false, function() {
    return [
...
_c = TestAuthDebugPage;
var _c;
__turbopack_context__.k.register(_c, "TestAuthDebugPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_85f885ca._.js.map