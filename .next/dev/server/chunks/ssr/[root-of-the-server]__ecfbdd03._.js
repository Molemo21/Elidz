...
async function getServerSession() {
    try {
        ...
        const { cookies } = await __turbopack_context__.A("[project]/node_modules/.pnpm/next@16.0.3_react-dom@19.2.0_react@19.2.0__react@19.2.0/node_modules/next/headers.js [app-rsc] (ecmascript, async loader)");
        const cookieStore = await cookies();
        const allCookies = cookieStore.getAll();
        const supabaseCookies = allCookies.filter((c)=>c.name.includes('sb-') && c.name.includes('auth'));
        console.log('[getServerSession] Available Supabase cookies:', supabaseCookies.map((c)=>c.name).join(', ') || 'None');
        console.log('[getServerSession] Total cookies:', allCookies.length);
...
"[project]/.next-internal/server/app/dashboard/business-profile/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/actions/create-user-record.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/app/actions/user-profiles.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/dashboard/business-profile/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/actions/create-user-record.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/app/actions/user-profiles.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
